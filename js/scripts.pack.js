...
const DFPManager = function (_base_reference) {
    ...
    function init() {
        ...
        if (base_reference.section == 'single') {
            ...
            googletag.cmd.push(function () {
                ...
                var boxBanner1 = googletag.defineSlot(unit1_name, [[300, 250], [300, 300]], boxBanner1_container.id).addService(googletag.pubads());
                var boxBanner2 = googletag.defineSlot(unit2_name, [[300, 250], [300, 300]], boxBanner2_container.id).addService(googletag.pubads());
                ...
                var banner_container, slot, unit3_name;
                if (base_reference.isMobile == 'true') {
                    try {
                        ...
                        slot = googletag.defineSlot(unit3_name, [[300, 300], [300, 250]], banner_container.id).addService(googletag.pubads());
                    } catch (e) {}
                    ...
                    try {
                        ...
                        slot = googletag.defineSlot(unit3_name, [[728, 90], [970, 250]], banner_container.id).addService(googletag.pubads());
                    } catch (e) {}
                }
    ...
    if (base_reference.section == 'single' || base_reference.section == 'home' || base_reference.section == 'category') init();
